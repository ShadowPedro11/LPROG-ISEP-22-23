...
public interface shortAnswerGrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link shortAnswerGrammarParser#questionValue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitQuestionValue(shortAnswerGrammarParser.QuestionValueContext ctx);
	/**
	 * Visit a parse tree produced by {@link shortAnswerGrammarParser#feedback}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFeedback(shortAnswerGrammarParser.FeedbackContext ctx);
	/**
