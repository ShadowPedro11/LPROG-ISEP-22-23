...
public interface matchingQuestionGrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link matchingQuestionGrammarParser#questionValue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitQuestionValue(matchingQuestionGrammarParser.QuestionValueContext ctx);
	/**
	 * Visit a parse tree produced by {@link matchingQuestionGrammarParser#feedback}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFeedback(matchingQuestionGrammarParser.FeedbackContext ctx);
	/**
