...
public interface multipleChoiceQuestionGrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link multipleChoiceQuestionGrammarParser#questionValue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitQuestionValue(multipleChoiceQuestionGrammarParser.QuestionValueContext ctx);
	/**
	 * Visit a parse tree produced by {@link multipleChoiceQuestionGrammarParser#feedback}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFeedback(multipleChoiceQuestionGrammarParser.FeedbackContext ctx);
	/**
